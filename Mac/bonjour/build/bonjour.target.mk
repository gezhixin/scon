...
OBJS := \
	...
	$(obj).target/$(TARGET)/BonjourJSBridge.o
...
$(builddir)/bonjour.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/bonjour.node: LIBS := $(LIBS)
$(builddir)/bonjour.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/bonjour.node: TOOLSET := $(TOOLSET)
$(builddir)/bonjour.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/bonjour.node
# Add target alias
.PHONY: bonjour
bonjour: $(builddir)/bonjour.node

# Short alias for building this executable.
.PHONY: bonjour.node
bonjour.node: $(builddir)/bonjour.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/bonjour.node
